...
public:
	...
	{
		std::cerr << "ServiceProvider: Message ignored" << std::endl;
		return "";
	}
};
...
public:
	...
	{
		std::cout << "ServiceProvider: Try to register " << p_msg.name << " service at [" << p_msg.host << ":" << p_msg.port << "]" << std::endl;
		...
		std::cout << "ServiceProvider: " << p_msg.name << " service registered at [" << resp.host << ":" << resp.port << "]" << std::endl;
		return resp;
	}
...
public:
	...
	{
		std::cout << "ServiceProvider: Release " << p_msg.name << " service" << std::endl;
...
public:
	...
	{
		std::cout << "ServiceProvider: Get " << p_msg.name << " service addr" << std::endl;
